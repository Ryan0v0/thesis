...
% Different from normal Federated Learning (), a general form of Vertical Federated Learning, where data are partitioned both in the sample and feature spaces.
...
This work present \emph{vFedSec} - an efficient and privacy-preserving way of training under the Vertical FL setup. %We propose this novel design, called \emph{vFedSec} in Section \ref{sec:secagg}, for training VFL securely and efficiently. 
...
\begin{algorithm}[!t]
    ...
    \EndProcedure
    \Procedure{ClientUpdate}{$k,w_t,x_{m},Z_a$}
        ...
        \EndFor
    \EndProcedure\Procedure{PseudoLabel}{$x_{m}, Z_a$}
...
% We might also enhance the aggregation method, contrasting with ScaleFL that depends on structural relationships and a self-distillation phase.
